<?php 
    ...
    $sql = "SELECT * FROM tarefas WHERE (situacao != 'CA') AND (situacao != 'CO') AND 
    (DATE(datahorainicio) BETWEEN CURDATE() AND DATE_ADD(CURDATE(), INTERVAL 7 DAY)) ORDER BY datahorainicio;";
