...
window.onload = function () {
    ...
    if (sessionStorage.getItem("idLogado") == null) {
        ...
        if (sessionStorage.getItem("id") != null) {
            ...
            titulo.innerHTML = `Alterar dados do tipo de evento`;
...
function consultaPorId() {
    $.ajax({
        url: servidor + 'tipoevento/consultarporid.php',
        dataType: 'json', 
...
function cadastrar() {
    ...
    if (txtDescricao.value == "") {
        ...
        $.ajax({
            url: servidor + 'tipoevento/inserir.php', 
            ...
            success: function (resposta) {
                ...
                Swal.fire({
                    title: 'Tipo de evento cadastrado com sucesso!',
...
function alterar() {
    ...
    if (txtDescricao.value == "") {
        ...
        // Define a função 'ajax' para enviar os dados para o servidor
        $.ajax({
            url: servidor + 'tipoevento/alterar.php',
            dataType: 'json', // Tipo dos dados que serão enviados
            type: 'POST', // Como os dados serão enviados
            data: { // Dados que serão enviados
                descricao: txtDescricao.value,
