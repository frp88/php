...
// Função que busca todos servidor
function listaProdutos() {
    $.ajax({
        url: servidor + 'produto/consultar.php',
        dataType: 'json',
        type: 'GET',
...
function preencheTabela(dados) {
    ...
    $('#tabela').on('click', '.btn-editar', function (e) {
        ...
        mostraFormulario(data.idproduto);
    });
    $('#tabela').on('click', '.btn-excluir', function (e) {
        var data = table.row($(this).parents('tr')).data();
        excluir(data.idproduto);
    });
}
...
function excluirProduto(id) {
    $.ajax({
        url: servidor + 'produto/excluir.php',
