...
window.onload = function () {
    ...
    if (sessionStorage.getItem("idLogado") == null) {
        ...
        if (sessionStorage.getItem("id") != null) {
            ...
            titulo.innerHTML = `Alterar dados do cliente`;
...
function defineTipoPessoa() {
    ...
    if (rbPessoaFisica.checked == true) { 
        ...
        document.getElementById(`txtNome`).placeholder = `Digite o nome`;
        document.getElementById(`lblRg`).innerHTML = `RG:`;
        document.getElementById(`txtRg`).placeholder = `Digite o RG`;
        document.getElementById(`lblCpf`).innerHTML = `CPF:`;
        document.getElementById(`txtCpf`).placeholder = `Digite o CPF`;
        document.getElementById(`lblData`).innerHTML = `Data de Nascimento:`;
    } else {
        document.getElementById(`lblNome`).innerHTML = `Nome Fantasia: *`;
        document.getElementById(`txtNome`).placeholder = `Digite o nome fantasia`;
        document.getElementById(`lblRg`).innerHTML = `Razão Social:`;
        document.getElementById(`txtRg`).placeholder = `Digite a razão social`;
        document.getElementById(`lblCpf`).innerHTML = `CNPJ:`;
        document.getElementById(`txtCpf`).placeholder = `Digite o CNPJ`;
...
function consultaPorId() {
    $.ajax({
        url: servidor + 'cliente/consultarporid.php',
        dataType: 'json',
        ...
        success: function (dados) {
            ...
            document.querySelector(`#lblRg`).innerHTML = (rbPessoaFisica.checked == true ? `RG` : `Razão Social`);
            //document.getElementById(`txtRazaoSocial`).placeholder = ``;
            //document.getElementById(`txtRazaoSocial`).disabled = (dados["tipo"] == `PF`);
           
            document.querySelector(`#lblCpf`).innerHTML = (rbPessoaFisica.checked == true ? `CPF` : `CNPJ:`);
            ...
            document.querySelector(`#txtCpf`).value = dados["cpf"];
            document.querySelector(`#txtRg`).value = dados["rg"];
            ...
            document.querySelector(`#txtDataNascimento`).value = dados["datanascimento"];
...
function cadastrar() {
    ...
    if (txtNome.value == "") {
        ...
        $.ajax({
            url: servidor + 'cliente/inserir.php',
...
function alterar() {
    ...
    if (txtNome.value == "") {
        ...
        // Define a função 'ajax' para enviar os dados para o servidor
        $.ajax({
            url: servidor + 'cliente/alterar.php',
            dataType: 'json', // Tipo dos dados que serão enviados
            type: 'POST', // Como os dados serão enviados
            data: { // Dados que serão enviados
                nome: txtNome.value,
...
function limparCampos(){
    document.querySelector(`#rbPessoaFisica`).checked = true;
    document.querySelector(`#rbPessoaJuridica`).checked = false;
